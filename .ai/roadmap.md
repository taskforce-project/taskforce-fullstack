...
> - **Reste** : increment 3 = Pilier 3 « connecte X » (injection du catalogue dans le prompt, générique). Puis `[TF-MCP-04]` = import de projet (Linear → issues natives) dans le wizard nouveau projet.
>
