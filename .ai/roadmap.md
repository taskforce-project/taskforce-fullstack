...
> - **Fix anim panneaux** : le slide d'ouverture (depuis hors écran à droite) créait une **barre de scroll horizontale transitoire** qui « repoussait » le contenu vers la gauche puis revenait → `overflow-hidden` sur le conteneur des panneaux (clip à la source), retour user.
