...
> - **Version** : front patch `0.3.7`→`0.3.8` + back patch `0.0.13`→`0.0.14` → produit **v0.3.22**. Gate `it.ps1 -Test GitHubIntegrationContractTest,SlackIntegrationContractTest` + `test:coverage` front : **en validation** (à confirmer verts avant release).
