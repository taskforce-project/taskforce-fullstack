...
> - **Reste (Phase 2 front)** : exposer `deletionScheduledAt` dans le profil + **bandeau** « compte prévu pour suppression le JJ/MM, restaurer ? » + **dialog** de suppression qui liste ce qui sera détruit (« définitif, membres perdent l'accès, transfère pour garder »).
>
