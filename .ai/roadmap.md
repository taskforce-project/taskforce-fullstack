...
> - **Reste (backlog v1)** : set MCP-ready avec URL suggérée (1-clic). ✅ **Surfacer les outils MCP dans Ask AI = FAIT** (02/09, empty-state Cortex, cf. `[V1-FIXES]` ci-dessus). Puis v2 (orchestrateur, assignation aux agents).
