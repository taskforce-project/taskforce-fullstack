...
> **▶ MAJ 25/09/2026, 3e passe (release en cours : produit v0.40.1) - Runner local : délégation jamais bloquée, flag durable, logo Anthropic retiré.** `[backend + frontend + landing + ops]`
