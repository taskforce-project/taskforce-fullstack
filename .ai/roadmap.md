...
> **▶ MAJ 26/08/2026 — QA-42 : landing — icônes des dropdowns ré-animées avec la VRAIE lib (framer-motion, comme la webapp) + vraies captures produit (hero + section Smart Assign) (à committer).** `[QA-42]`
