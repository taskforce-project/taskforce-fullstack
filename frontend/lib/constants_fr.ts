...
export const CONSTANTS_FR: TranslationKeys = {
  ...
  auth: {
    ...
    ui: {
      ...
      twoFactorUseAnother: "← Utiliser une autre adresse",
      twoFactorEnterCode: "Entrez le code à 6 chiffres.",
      twoFactorTooManyCodes: "Trop de codes erronés. Patientez une minute et réessayez.",
      twoFactorSetupTitle: "Activer la double authentification",
      twoFactorSetupDesc: "Scannez le QR code avec votre application d'authentification (Google Authenticator, Authy, 1Password…), puis entrez le code à 6 chiffres pour confirmer.",
  ...
  shell: {
    ...
    workspaceActivity: "Que fait ton entreprise / équipe ?",
    workspaceActivityPlaceholder: "ex. On construit un CRM pour les artisans",
    workspaceActivityHint: "Une phrase. Elle nourrit ton Brain OS pour que l'IA comprenne ton contexte.",
